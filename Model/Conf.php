...
class Conf
{
    ...
    public function getProcessConfiguration()
    {
        return[
            ...
            ['reward_exchange_rate.json'=>['process'=>'graphql','class'=>$this->rewardExchangeRateInstall,
            'label'=>'Loading Rewards Exchange Rate']],
            ...
            ['product_attributes.json'=>['process'=>'graphql','class'=>$this->productAttributesInstall,
            'label'=>'Loading Product Attributes']],
            ...
            ['customer_segments.json'=>['process'=>'graphql','class'=>$this->customerSegmentsInstall,
            'label'=>'Loading Customer Segments']],
            ['msi_source.csv'=>['process'=>'rows','class'=>$this->msiSourceInstall,
            'label'=>'Loading MSI Source']],
            ['msi_source.json'=>['process'=>'graphql','class'=>$this->msiSourceInstall,
            'label'=>'Loading MSI Source']],
            ['msi_stock.csv'=>['process'=>'rows','class'=>$this->msiStockInstall,
            'label'=>'Loading MSI Stock']],
            ['msi_stock.json'=>['process'=>'graphql','class'=>$this->msiStockInstall,
            'label'=>'Loading MSI Stock']],
