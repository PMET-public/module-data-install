...
class Widgets
{
    ...
    Helper $helper, Converter $converter,ThemeCollection $themeCollection, Stores $stores,State $appState,
    ...
    if (empty($row['title'])){
        $this->helper->printMessage("title is required in the widgets data file. Row has been skipped.","warning");
        return true;
    }
    if (empty($row['instance_type'])){
        $this->helper->printMessage("instance_type is required in the widgets data file. Row has been skipped.","warning");
        return true;
    }
    ...
    if(!$type){
        $this->helper->printMessage("Type ".$row['instance_type']." is invalid for widget ".$row['title'].". Row has been skipped.","warning");
    }
    /** @var Instance $widget */
